...
(custom-set-variables
 ...
 '(package-selected-packages
   (quote
    (org-roam neotree kotlin-mode unicode-emoticons unicode-fonts use-package doom-modeline doom-themes ssh telega lsp-mode ace-window switch-window web-mode haskell-mode w3m elm-mode tabbar python-mode racket-mode auto-complete)))
 '(show-paren-mode t)
 '(tool-bar-mode nil))
(custom-set-faces
