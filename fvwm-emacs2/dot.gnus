...
(defun set-domain ()
   (interactive)
   (message "from xxx")
   (setq user-mail-address "xxx@domain.org")
   (setq message-sendmail-extra-arguments (list '"-a" "domain"))
 ;  (setq gnus-message-archive-group nil)
   ...
   (setq message-default-mail-headers
	 "Cc: xxx@domain.com\nBcc: xxx@domain.net\n"))
;   (setq message-default-mail-headers
;      "Bcc: xxx@domain.com, xxx@domain.net\n"))
...
;  (setq message-default-mail-headers
;	"Bcc: x@qq.com, xx@qq.com\n"))
 
;;;Select automatically while replying 
(add-hook 'message-mode-hook
 	  '(lambda ()
 	     (cond ((string-match "qq:" gnus-newsgroup-name) (set-qq))
		   (t (set-domain)))))
...
;      smtpmail-starttls-credentials '(("domain.org" 587 nil nil))
;      smtpmail-auth-credentials '(("domain.org" 587
;				   "user-name-like-x" nil))
;      smtpmail-default-smtp-server "domain.org"
;      smtpmail-smtp-server "domain.org"
;      smtpmail-smtp-service 587
;      gnus-ignored-newsgroups "^to\\.\\|^[0-9. ]+\\( \\|$\\)\\|^[\"]\"[#'()]")
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;

;;; set mail address as alias, to write alias me "x@domain.org" into ~/.mailrc, and input me after
;;; To: on gnus and hit space , it will transform to x@domain.org

(setq-default
 user-mail-address "x@domain.org"
...
;(setq display-time-mail-directory "~/Mail/domain/INBOX/new")
